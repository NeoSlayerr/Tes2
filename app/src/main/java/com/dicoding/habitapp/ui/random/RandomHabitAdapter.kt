...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val ivLevel: ImageView = itemView.findViewById(R.id.item_priority_level)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            when(pageType){
                PageType.HIGH -> {
                    ...
                    ivLevel.setImageResource(R.drawable.ic_priority_high)
                ...
                PageType.MEDIUM -> {
                    ...
                    tvStartTime.text = pageData.startTime
                    tvMinutes.text = pageData.minutesFocus.toString()
                    ivLevel.setImageResource(R.drawable.ic_priority_medium)
                    btnOpenCountDown.setOnClickListener {
                        onClick(pageData)
                    }
                }
                PageType.LOW -> {
                    ...
                    tvStartTime.text = pageData.startTime
                    tvMinutes.text = pageData.minutesFocus.toString()
                    ivLevel.setImageResource(R.drawable.ic_priority_low)
                    btnOpenCountDown.setOnClickListener {
                        onClick(pageData)
                    }
                }
